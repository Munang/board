...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter { // 2
    ...
    public void configure(WebSecurity web) { // 4
        //4. `WebSecurityConfigurerAdapter`를 상속받으면 오버라이드할 수 있습니다.인증을 무시할 경로들을 설정해놓을 수 있습니다.
    ...
    protected void configure(HttpSecurity http) throws Exception { // 5
        //5. `WebSecurityConfigurerAdapter`를 상속받으면 오버라이드할 수 있습니다.
        ...
        http
                ...
                .antMatchers("/auth/login", "/auth/signup", "/auth/user").permitAll() // 누구나 접근 허용
